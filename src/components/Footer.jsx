    ...
    return(
        ...
        <div className='bg-[#F5F5F7] mt-10'>
            <div className=' py-5  max-w-5xl m-auto '>
                <div className='text-xs text-gray-500 flex flex-col gap-5 py-5 border-b border-gray-400'>
                    <p>
                    ...
                    <p>
                        Hearing Protection: The Hearing Protection feature works with AirPods Pro 2 with the latest firmware when paired with a compatible iPhone, iPad, or Mac with iOS 18, iPadOS 18, or macOS Sequoia and later. Feature is only available in the U.S. and Canada. See <a href="" className='underline font-semibold'>support.apple.com/120850</a> for total attenuation and more information. The Hearing Protection feature is not suitable for protection against extremely loud impulse sounds, such as gunfire, fireworks, or jackhammers, or against sustained sounds louder than 110 dBA.
                    </p>
                    <p>
                ...
                <div className='border-b border-gray-400'>
                    <div className='grid grid-cols-5 my-5'>
                        <div className='flex flex-col gap-4'>
                            ...
                            <ul className='text-xs text-gray-500 flex flex-col gap-4'>
                ...
                <div className='text-gray-500 text-xs flex justify-between my-5'>
                    <div>
